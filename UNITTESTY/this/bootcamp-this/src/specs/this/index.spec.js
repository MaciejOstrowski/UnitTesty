describe('casting this to a temporary variable', () => {
    it('should call the most outer context object property', function(){
        ...
        function outerContext() {
            ...
            expect(outerSayName()).toEqual("Freddie");
...
describe('using the call(), apply() and bind() methods to change the context', () => {
    ...
    it('should use the bind() method to change the context', function(){
        ...
        expect(myCallers.callerFunction1(person2.name)).toEqual("Zakk would be 78 years old");
        expect(myCallers.callerFunction2(person1.name)).toEqual("John would be 72 years old");
        expect(myCallers.callerFunction3(this.name)).toEqual("Freddie is 51 years old");
        expect(myCallers.callerFunction4()).toEqual("Zakk would be 72 years old");
        expect(myCallers.callerFunction5()).toEqual("Freddie would be 78 years old");
